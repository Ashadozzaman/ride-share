        ...
        <div class="h-screen flex">
            <nav :class="`h-full bg-slate-50 ${toggleSidebar ? 'w-[210px]' : ''} `">
                <div class="flex flex-row justify-between p-3">
                    <img v-show="toggleSidebar ? true : false" :src="App.baseUrl + '/images/logo.png'" class="w-10"
                        src="" alt="">
            ...
            <div class="bg-slate-200 w-full">
                    ...
                    <div class="p-3">
                        ...
                        <ul v-show="toggleTopManu"
                            ...
                            <li class="p-2">
                                ...
                                <a class="text-indigo-600" href="">ashadozzaman@gmail.com</a>

                            </li>
                            <li class="p-2 hover:bg-gray-100 rounded-md cursor-pointer text-red-600 fot-semibold">
                                <a href="">Logout</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="flex p-10">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut quod itaque porro ex, temporibus
                        obcaecati quaerat tenetur vero ratione aliquam quis! Ex ipsam omnis quam. Vero ratione accusamus
...
// import ChevroIcon from "../../../components/icons/ChevroIcon.vue";
